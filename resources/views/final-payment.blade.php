                        ...
                        <form class="custom-form donate-form" action="#" method="get" role="form">
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-12 mb-3">
                                    <h5 class="">Batas Waktu Pembayaran :</h5>
                                    <div class="badge bg-primary text-wrap" >
                                        Rabu, 12 April 2023 12.14 WIB
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-12 mt-2">
                                    <h5 class="">Nomor Pembayaran</h5>
                                </div>
                                <div class="col-lg-12 col-12">
                                    <input class="form-control" type="text" value="1225638514795255" aria-label="Disabled input example" disabled readonly>
                            ...
                            <button type="submit" class="form-control mt-4">Cek Status Pembayaran</button>
                        </form>
                    </div>
