        ...
        <div class="slider">
            ...
            <div class="card" style="max-width: 330px">
                ...
                <div class="custom-block-body" >
                    ...
                    <hr>
                    <div class="d-flex align-items-center my-2" style="font-size: 10px">
                        <p class="mb-0">
                            60 Donatur
                        </p>
                        <p class="ms-auto mb-0" >
                ...
                <a href="/donate/{{$item->id}}" class="custom-btn btn" >Donate now</a>
            </div>
            @endforeach
          </div>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="slider">
                ...
                <div class="card" style="max-width: 330px">
                    ...
                    <button a href="/donate/{{$item->id}}" class="custom-btn btn" >Donate now</a>
                </div>
                @endforeach
              </div>
