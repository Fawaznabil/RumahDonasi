					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
								<!--begin::Form-->
								<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="../../demo10/dist/authentication/layouts/overlay/sign-in.html" action="" method="POST">
                                    @csrf
									<!--begin::Heading-->
									...
									<div class="row g-3 mb-9">
										...
										<div class="col-md-6">
											...
											<img alt="Logo" src="{{ asset('assets/google.png') }}" class="h-15px me-3" />Sign in with Google</a>
											<!--end::Google link=-->
										</div>
                                        <div class="col-md-6">
											<!--begin::Google link=-->
											<a href="#" class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
											<img alt="Logo" src="{{ asset('assets/facebook.png') }}" class="h-15px me-3" />Sign in with Facebook </a>
											<!--end::Google link=-->
										</div>
									</div>
									<!--end::Login options-->
