            ...
            <div class="d-flex flex-lg-row-fluid">
                ...
                <div class="d-flex flex-column flex-center pb-0 pb-lg-10 p-10 w-100">
                    ...
                    <img class="theme-light-show mx-auto mw-100 w-150px w-lg-300px mb-10 mb-lg-20"
                        src="{{ asset('assets/logo-2.png')}}" alt="" />
                    ...
                    <div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
                        ...
                        <div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
                            ...
                            <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                                data-kt-redirect-url="../../demo10/dist/index.html" action="{{ route('post_login') }}"
                                method="POST">
                                @csrf
                                <!--begin::Heading-->
                                ...
                                <div class="row g-3 mb-9">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="{{ route('google.login') }}"
                                            ...
                                            <img alt="{{ asset('assets/google.png') }}"
                                                src="{{ asset('assets/google.png') }}" class="h-15px me-3" />Sign in
                                            with Google</a>
                                        <!--end::Google link=-->
                                    </div>
                                    <!--end::Col-->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="#"
                                            class="btn btn-flex btn-outline btn-text-gray-700 btn-active-color-primary bg-state-light flex-center text-nowrap w-100">
                                            <img alt="Logo" src="{{ asset('assets/facebook.png') }}"
                                ...
                                <div class="position-relative mb-3">
                                    <input class="form-control bg-transparent" type="password" placeholder="Password"
                                        name="password" autocomplete="off" id="sandi-input" />
                                        <span
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            fill="currentColor" class="bi bi-eye-slash-fill d-none"
                                            viewBox="0 0 16 16">
                                            <path
