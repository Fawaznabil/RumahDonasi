...
<html lang="en">
	...
	<body id="kt_body" class="auth-bg bgi-size-cover bgi-position-center">
		...
		<div class="d-flex flex-column flex-root">
			<!--begin::Page bg image-->
			<style>body { background-image: url(''); } [data-bs-theme="dark"] body { background-image: url('assets/media/auth/bg10-dark.jpeg'); }</style>
			<!--end::Page bg image-->
					...
					<div class="bg-body d-flex flex-column flex-center rounded-4 w-md-600px p-10">
						...
						<div class="d-flex flex-center flex-column align-items-stretch h-lg-100 w-md-400px">
							...
							<div class="d-flex flex-center flex-column-fluid pb-15 pb-lg-20">
								<!--begin::Form-->
								<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="../../demo10/dist/index.html" action="{{ route('post_login') }}" method="POST">
                                    @csrf
									<!--begin::Heading-->
									...
									<div class="row g-3 mb-9">
										...
										<div class="col-md-6">
											...
											<img alt="{{ asset('assets/google.png') }}" src="{{ asset('assets/google.png') }}" class="h-15px me-3" />Sign in with Google</a>
											<!--end::Google link=-->
										</div>
										<!--end::Col-->
										<!--begin::Col-->
										<div class="col-md-6">
											...
											<img alt="Logo" src="{{ asset('assets/facebook.png') }}" class="theme-light-show h-15px me-3" />
											<img alt="Logo" src="{{ asset('assets/facebook.png') }}" class="theme-dark-show h-15px me-3" />Sign in with facebook</a>
											<!--end::Google link=-->
										</div>
										<!--end::Col-->
									</div>
