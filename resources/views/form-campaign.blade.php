...
<body id="kt_body" class="header-tablet-and-mobile-fixed aside-enabled">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-px text-center pt-15 pb-15">
                                <!--begin::Title-->
                                <h2 class="fs-2x fw-bold mb-0">Create Campaign Rumah Donasi</h2>
                                <!--end::Title-->
                                <!--begin::Description-->

                                {{-- <p class="text-gray-400 fs-4 fw-semibold py-7">Click Create Campaign
                            ...
                            <div class="text-center pb-15 px-5">
                                <img src="assets/2.png" alt="" class="mw-100 h-200px h-sm-325px" />
                            </div>
                            <!--end::Illustration-->
                        </div>
                        <!--end::Card body-->
    ...
    <div id="kt_activities" class="bg-body" data-kt-drawer="true" data-kt-drawer-name="activities"
        ...
        <div class="card shadow-none border-0 rounded-0">
            ...
            <div class="card-footer py-5 text-center" id="kt_activities_footer">
                <a href="../../demo10/dist/pages/user-profile/activity.html" class="btn btn-bg-body text-primary">View
                    All Activities
                                ...
                                <div class="pt-5 tab-pane fade show active" id="kt_app_engage_prebuilts_tab_dashboards"
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/dashboards/social.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/dashboards/delivery.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/dashboards/school.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/dashboards/crypto.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/dashboards/bidding.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/dashboards/podcast.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                            ...
                                            <div class="col-md-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/dashboards/projects.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                ...
                                <div class="pt-5 tab-pane fade" id="kt_app_engage_prebuilts_tab_apps" role="tabpanel">
                                    ...
                                    <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                        ...
                                        <div class="row gy-10">
                                            ...
                                            <div class="col-lg-4">
                                                <!--begin::Preview-->
                                                <a href="../../demo10/dist/apps/chat/private.html" data-kt-href="true"
                                                    class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                    <!--begin::Title-->
                                                    <h3
                                                        class="ps-12 pt-9 mb-7 text-gray-900 fw-bold letter-spacing fs-4">
                                ...
                                <div class="mb-10 mb-lg-17">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold"
                                                    ...
                                                    Dashboard</a>
                                                <a class="fw-6 fw-semibold"
                                                    href="../../demo10/dist/dashboards/social.html">Social Dashboard</a>
                                                <a class="fw-6 fw-semibold"
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                <a class="fw-6 fw-semibold"
                                                    href="../../demo10/dist/dashboards/call-center.html">Call Center</a>
                                                <a class="fw-6 fw-semibold"
                                ...
                                <div class="mb-10 mb-lg-17">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                <a class="fw-6 fw-semibold"
                                                    href="../../demo10/dist/utilities/wizards/horizontal.html">2 Factor
                                                    Auth</a>
                                            </div>
                                            <!--end::List-->
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                ...
                                                <a class="fw-6 fw-semibold" href="../../demo10/dist/pages/team.html">Our
                                                    Team</a>
                                            </div>
                                            <!--end::List-->
                                        </div>
                                ...
                                <div class="mb-10 mb-lg-17">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <div class="d-flex flex-column gap-3 gap-lg-5">
                                                <a class="fw-6 fw-semibold"
                                                    href="../../demo10/dist/pages/faq/extended.html">FAQ Extended</a>
                                            </div>
                                            <!--end::List-->
                                        </div>
                                        <!--end::Col-->
                ...
                <div class="modal-body scroll-y m-5">
                    ...
                    <div class="stepper stepper-links d-flex flex-column" id="kt_modal_create_campaign_stepper">
                        ...
                        <div class="stepper-nav justify-content-center py-2">
                            ...
                            <!--begin::Step 3-->
                            <div class="stepper-item me-5 me-md-15" data-kt-stepper-element="nav">
                                <h3 class="stepper-title">Foto Deskripsi</h3>
                            </div>
                            <!--end::Step 3-->

                            <!--begin::Step 5-->
                            <div class="stepper-item" data-kt-stepper-element="nav">
                                <h3 class="stepper-title">Complated</h3>
                            </div>
                            <!--end::Step 5-->
                        </div>
                        <!--end::Nav-->
                        ...
                        <form class="mx-auto w-100 mw-600px pt-15 pb-10" novalidate="novalidate"
                            id="kt_modal_create_campaign_stepper_form" action="/Home" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="mb-10 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            name="namaLembaga" placeholder="" value="" />
                                        <!--end::Input-->
                                    </div>

                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="required form-label mb-3">Lokasi Tinggal</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                    ...
                                    <div class="fv-row mb-10">
                                        <!--end::Label-->
                                        <label class="required form-label">Tentang Diri Kamu</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <textarea name="deskripsiDiri"
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    <div class="fv-row mb-10">
                                        <!--begin::Label-->
                                        <label class="form-label required">Kategori apa yang paling tepat untuk
                                            penggalangan dana ini?</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                    ...
                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label required">Apa judul untuk penggalangan dana
                                            ini?</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            name="judul" placeholder="" value="" />
                                        <!--end::Input-->
                                    </div>
                                    ...
                                    <div class="fv-row mb-8">
                                        <!--begin::Label-->
                                        <label class="required fs-6 fw-semibold mb-2">Batas Waktu Penggalangan dana</label>
                                        <!--end::Label-->
                                        <!--begin::Wrapper-->
                                        <div class="position-relative d-flex align-items-center">
                                            ...
                                            <!--end::Icon-->
                                            <!--begin::Input-->
                                            <input class="form-control form-control-solid ps-12" type="date" id="birthday" name="batasWaktu" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Wrapper-->
                                    </div>
                                    ...
                                    <div class="mb-10 fv-row">
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                             placeholder="Target donasi dan batas waktu dapat diubah sewaktu-waktu jika diperlukan" value="Target donasi dan batas waktu dapat diubah sewaktu-waktu jika diperlukan" disabled style="background-color: rgb(249, 251, 208)"/>
                                        <!--end::Input-->
                                    </div>

                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label required">Tujuan Galang Dana</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            name="tujuan" placeholder="" value="" />
                                        <!--end::Input-->
                                    </div>

                                    <div class="mb-10 fv-row">
                                        <!--begin::Label-->
                                        <label class="form-label required">Penerima Manfaat</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            name="manfaat" placeholder="" value="" />
                                        <!--end::Input-->
                                    </div>

                                    <div class="fv-row mb-10">
                                        <!--end::Label-->
                                        <label class="form-label">Rincian Penggunaan jika dana donasi terkumpul</label>
                                        <!--end::Label-->
                                        <!--begin::Input-->
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="fv-row mb-10">
                                        <div class="fv-row mb-10">
											...
											<label class="d-block fw-semibold fs-6 mb-5">
												<span class="required">Pilih salah satu foto utama untuk penggalangan danamu</span>
                                    ...
                                    <div class="fv-row mb-10">
                                        <div class="form-group">
                                            <label class="form-label required">Tulis ajakan singkat untuk mengajak orang berdonasi</label>
                                            <textarea class="form-control" id="exampleFormControlTextarea3" name="ajakan"rows="3"></textarea>
                                          </div>
                                    </div>
                            ...
                            <div data-kt-stepper-element="content">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="mb-10">
                                        <!--begin::Label-->
                                        <label class="required fw-semibold fs-6 mb-5">Galang dana ini ditunjukan untuk keperluan?</label>
                                        <!--end::Label-->
                                        <!--begin::Roles-->
                                        <!--begin::Input row-->
                                        <div class="d-flex fv-row">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                <!--begin::Input-->
                                                <input class="form-check-input me-3" name="tujuanDana" type="radio" value="Saya sendiri" id="kt_modal_update_role_option_0" checked='checked' />
                                                <!--end::Input-->
                                                <!--begin::Label-->
                                                <label class="form-check-label" for="kt_modal_update_role_option_0">
                                                    <div class="fw-bold text-gray-800">Saya sendiri</div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Radio-->
                                        ...
                                        <div class="d-flex fv-row">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                <!--begin::Input-->
                                                <input class="form-check-input me-3" name="tujuanDana" type="radio" value="Keluarga/Kerabat" id="kt_modal_update_role_option_1" />
                                                <!--end::Input-->
                                                <!--begin::Label-->
                                                <label class="form-check-label" for="kt_modal_update_role_option_1">
                                                    <div class="fw-bold text-gray-800">Keluarga/Kerabat</div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Radio-->
                                        ...
                                        <div class="d-flex fv-row">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                <!--begin::Input-->
                                                <input class="form-check-input me-3" name="tujuanDana" type="radio" value="Organisasi/Lembaga" id="kt_modal_update_role_option_2" />
                                                <!--end::Input-->
                                                <!--begin::Label-->
                                                <label class="form-check-label" for="kt_modal_update_role_option_2">
                                                    <div class="fw-bold text-gray-800">Organisasi/Lembaga</div>
                                                </label>
                                                <!--end::Label-->
                                            </div>
                                            <!--end::Radio-->
                                        ...
                                        <div class="d-flex fv-row">
                                            ...
                                            <div class="form-check form-check-custom form-check-solid">
                                                <!--begin::Input-->
                                                <input class="form-check-input me-3" name="tujuanDana" type="radio" value="Lainnya" id="kt_modal_update_role_option_3" />
                                                <!--end::Input-->
                                                <!--begin::Label-->
                                    ...
                                    <div class="fv-row mb-15">
                                        ...
                                        <div class="d-flex flex-stack">
                                            <!--begin::Label-->
                                            <div class="me-5">
                                                <label class="fs-6 fw-semibold" style="background-color: rgb(249, 251, 208)">Saya setuju dengan Syarat dan Ketentuan Donasi di Rumah Donasi, termasuk biaya administrasi pltaform sebesar 5% dari total donasi online yang terkumpul!</label>
                                            </div>
                                            <!--end::Label-->
                                            <!--begin::Switch-->
    ...
    <script>
        $('#flatpicker-date-only').flatpickr()({
            enableTime: false,
            dateFormat: "Y-m-d",
        });
        $('#flatpicker-datetime').flatpickr({
            enableTime: true,
            dateFormat: "Y-m-d H:i",
        });
        $('#flatpicker-time-only').flatpickr({
            enableTime: true,
            noCalendar: true,
            dateFormat: "H:i",
        });
