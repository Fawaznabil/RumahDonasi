...
<body>
        ...
        <body id="kt_body" class="header-tablet-and-mobile-fixed aside-enabled">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                <a href="#"
                                                    class="text-gray-900 text-hover-primary fs-2 fw-bold me-1">xxxx</a>
                                                <a href="#">
            ...
            <div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
                ...
                <div class="card-header cursor-pointer">
                    ...
                    <!--end::Card title-->
                    <!--begin::Action-->
                    <a href="{{ asset("/editprofile") }}" class="btn btn-sm btn-primary align-self-center">Edit
                        Profile</a>
                    <!--end::Action-->
                </div>
                <!--begin::Card header-->
                ...
                <div class="card-body p-9">
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-2 fw-semibold text-muted">Nama</label>
                        <!--end::Label-->
                        <!--begin::Col-->
                        <div class="col-lg-8">
                            <span class="fw-bold fs-6 text-gray-800">xxxxx</span>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row mb-7">
                        ...
                        <div class="col-lg-8 fv-row">
                            <span class="fw-semibold text-gray-800 fs-6">xxxxx</span>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Input group-->
                    ...
                    <div class="row mb-7">
                        <!--begin::Label-->
                        <label class="col-lg-2 fw-semibold text-muted">No Telepon
                                    ...
                                    <div class="timeline-content mt-n1">
                                        ...
                                        <div class="pe-3 mb-5">
                                            ...
                                            <div class="fs-5 fw-semibold mb-2">New order
                                                ...
                                                for Workshow Planning & Budget Estimation</div>
                                            <!--end::Title-->
                                            <!--begin::Description-->
                                            <div class="d-flex align-items-center mt-1 fs-6">
                                                <!--begin::Info-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex flex-column me-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="text-gray-400 fw-semibold d-block">The best kitchen gadget in
                                        2022</span>
                                </div>
                                <!--end::Section-->
                                <!--begin::Section-->
                                    ...
                                    <div class="d-flex flex-center" id="kt_app_engage_prebuilts_view_image_tabs">
                                        ...
                                        <ul class="nav nav-tabs border-0 mb-5">
                                            ...
                                            <li class="nav-item px-2">
                                                ...
                                                <a class="nav-link btn btn-active-light btn-color-gray-600 btn-active-color-gray-800 fs-5 fw-bold"
                                                    data-bs-toggle="tab"
                                                    href="#kt_app_engage_prebuilts_tab_apps">Apps</a>
                                                <!--end::Tab link-->
                                            </li>
                                            <!--end::Tab item-->
                                        </ul>
                                        ...
                                        <div class="pt-5 tab-pane fade show active"
                                            ...
                                            <div class="hover-scroll-y pe-12 me-n12" data-kt-scroll="true"
                                                ...
                                                <div class="row gy-10">
                                                    ...
                                                    <div class="col-md-4">
                                                        <!--begin::Preview-->
                                                        <a href="../../demo10/dist/dashboards/pos.html"
                                                            data-kt-href="true"
                                                            class="preview-thumbnail bg-light border d-flex flex-column rounded-3 hover-elevate-up overflow-hidden">
                                                            <!--begin::Title-->
                                                            <h3
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-3 gap-lg-5">
                                                        ...
                                                        <a class="fw-6 fw-semibold"
                                                            ...
                                                            Courses</a>
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/dashboards/school.html">Hello
                                                            Tyler</a>
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/dashboards/crypto.html">My
                                                            Balance: 37,045$</a>
                                                    </div>
                                                    <!--end::List-->
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-3 gap-lg-5">
                                                        <a class="fw-6 fw-semibold"
                                                            ...
                                                            Center</a>
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/dashboards/pos.html">POS
                                                            System</a>
                                                    </div>
                                                    <!--end::List-->
                                                </div>
                                        ...
                                        <div class="mb-10 mb-lg-17">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-3 gap-lg-5">
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/account/api-keys.html">API
                                                            Keys</a>
                                                        <a class="fw-6 fw-semibold"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-3 gap-lg-5">
                                                        ...
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/pages/contact.html">Contact
                                                            Us</a>
                                                    </div>
                                                    <!--end::List-->
                                                </div>
                                        ...
                                        <div class="mb-10 mb-lg-17">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-3 gap-lg-5">
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/pages/faq/classic.html">FAQ
                                                            Classic</a>
                                                    </div>
                                                    <!--end::List-->
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-3 gap-lg-5">
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/pages/blog/home.html">Blog
                                                            Home</a>
                                                    </div>
                                                    <!--end::List-->
                                                </div>
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-3 gap-lg-5">
                                                        <a class="fw-6 fw-semibold"
                                                            href="../../demo10/dist/pages/blog/post.html">Blog
                                                            Post</a>
                                                    </div>
                                                    <!--end::List-->
                                                </div>
                                            ...
                                            <label
                                                ...
                                                <div class="d-flex align-items-center me-2">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <div class="fw-semibold opacity-75">Best value for 1000+
                                                            team</div>
                                                    </div>
                                                    <!--end::Info-->
                                                </div>
                                        ...
                                        <div class="tab-content rounded h-100 bg-light p-10">
                                            ...
                                            <div class="tab-pane fade show active" id="kt_upgrade_plan_startup">
                                                ...
                                                <div class="pb-5">
                                                    ...
                                                    <div class="text-muted fw-semibold">Optimal for 10+ team size
                                                        and new startup</div>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Body-->
                                            ...
                                            <div class="tab-pane fade" id="kt_upgrade_plan_advanced">
                                                ...
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s in Startup Plan?</h2>
                                                    <div class="text-muted fw-semibold">Optimal for 100+ team size
                                            ...
                                            <div class="tab-pane fade" id="kt_upgrade_plan_custom">
                                                ...
                                                <div class="pb-5">
                                                    <h2 class="fw-bold text-dark">What’s in Startup Plan?</h2>
                                                    <div class="text-muted fw-semibold">Optimal for corporations
                                                    </div>
                                                </div>
                                                <!--end::Heading-->
                                                <!--begin::Body-->
                                    ...
                                    <div class="current" data-kt-stepper-element="content">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="pb-10 pb-lg-15">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Notice-->
                                                <div class="text-muted fw-semibold fs-6">If you need more info,
                                                    please check out
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="fw-bold text-gray-800">Get more visitors
                                                            </div>
                                                            <div class="text-gray-600">Increase impression traffic
                                                                onto the platform</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="fw-bold text-gray-800">Get more messages on
                                                                chat</div>
                                                            <div class="text-gray-600">Increase community
                                                                interaction and communication</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="text-gray-600">Boost telecommunication
                                                                feedback to provide precise and accurate information
                                                            </div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="text-gray-600">Increase positive
                                                                interactivity on social media platforms</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                                ...
                                                <div class="d-flex fv-row">
                                                    ...
                                                    <div class="form-check form-check-custom form-check-solid">
                                                        ...
                                                        <label class="form-check-label"
                                                            ...
                                                            <div class="text-gray-600">Collect contact information
                                                                for potential customers</div>
                                                        </label>
                                                        <!--end::Label-->
                                                    </div>
                                                    <!--end::Radio-->
                                    ...
                                    <div data-kt-stepper-element="content">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="pb-10 pb-lg-12">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Description-->
                                                <div class="text-muted fw-semibold fs-4">If you need more info,
                                                    please check
                                                    ...
                                                    <div class="dz-message needsclick">
                                                        ...
                                                        <div class="ms-4">
                                                            <h3 class="dfs-3 fw-bold text-gray-900 mb-1">Drop
                                                                campaign files here or click to upload.</h3>
                                    ...
                                    <div data-kt-stepper-element="content">
                                        ...
                                        <div class="w-100">
                                            ...
                                            <div class="pb-12 text-center">
                                                ...
                                                <!--end::Title-->
                                                <!--begin::Description-->
                                                <div class="fw-semibold text-muted fs-4">You will receive an email
                                                    with with the summary of your newly created campaign!</div>
                                                <!--end::Description-->
                                            </div>
                                            <!--end::Heading-->
                                            <!--begin::Actions-->
                                                    ...
                                                    <label class="d-flex flex-stack cursor-pointer mb-5">
                                                        ...
                                                        <span class="d-flex align-items-center me-2">
                                                            ...
                                                            <span class="d-flex flex-column">
                                                                ...
                                                                <span class="fs-7 text-muted">Robust and flexible
                                                                    app framework</span>
                                                            </span>
                                                            <!--end:Info-->
                                                        </span>
                                                    ...
                                                    <span class="d-flex">
                                                        ...
                                                        <span class="ms-4">
                                                            <span
                                                                ...
                                                                Deal</span>
                                                            <span class="fw-semibold fs-4 text-muted">If you need
                            ...
                            <div class="container">
                                <div class="row justify-content-center align-items-center">
                                    ...
                                    <div class="col-lg-5 col-12 ms-auto">
                                        <h2 class="mb-0">Terimakasih telah Berbagi Bersama<br> #RumahDonasi</h2>
                                    </div>
            ...
            <div class="row">
                <div class="container">
                    <div class="row" style="background-color: rgb(241, 250, 252)">
                        <a href="/sesi/logout" class="custom-btn btn smoothscroll">Keluar</a>
                    </div>
                </div>
            </div>
    ...
    <script src="{{ asset('datatables1.bundle.js') }}"></script>
    <!--end::Vendors Javascript-->
    <!--begin::Custom Javascript(used for this page only)-->
    <script src="{{ asset('general.js') }}"></script>
    <script src="{{ asset('widgets.bundle.js') }}"></script>
    <script src="{{ asset('custom/widgets.js') }}"></script>
    <script src="{{ asset('custom/apps/chat/chat.js') }}"></script>
