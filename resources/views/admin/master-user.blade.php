											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<div class="w-150px me-3">
													...
													<select class="form-select form-select-solid" data-control="select2" data-hide-search="true" data-placeholder="Status" data-kt-ecommerce-order-filter="status">
														...
														<option value="active">Campaigner</option>
														<option value="locked">Donatur</option>
                                                        <option value="locked">Admin</option>
													</select>
													<!--end::Select2-->
												</div>
												<!--end::Filter-->
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
											...
											<tbody class="fw-semibold text-gray-600">
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Robert Doe</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">John Miller</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
												...
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo10/dist/apps/ecommerce/customers/details.html" class="text-gray-800 text-hover-primary mb-1">Lucy Kunic</a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
