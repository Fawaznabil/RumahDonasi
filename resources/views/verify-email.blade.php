				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							<!--begin::Logo-->
							<div class="mb-14">
								<a href="../../demo10/dist/index.html" class="">
									<img alt="Logo" src="assets/mitra-logo-pink309.png" class="h-40px" />
								</a>
							</div>
							<!--end::Logo-->
							<!--begin::Title-->
							...
							<div class="fs-6 mb-8">
								...
								<a href="../../demo10/dist/authentication/layouts/corporate/sign-up.html" class="link-primary fw-bold">Try Again</a>
							</div>
							<!--end::Action-->
							<!--begin::Link-->
							<div class="mb-11">
